...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		order=100;new Game.Upgrade('Duodecillion fingers',getStrThousandFingersGain(20)+'<q>Congratulations.<br>You\'ve mastered the core mechanic of the game.</q>',10000000000000000000000000000000,[12,37]);Game.MakeTiered(Game.last,16,0);
