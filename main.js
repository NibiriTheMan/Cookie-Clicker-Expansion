...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.Tiers={
			...
			15:{name:'Kalathunzite',unlock:700,achievUnlock:700,iconRow:36,color:'#ffddbb',price:		50000000000000000000000000000000000000000000},
		...
		order=100;new Game.Upgrade('Duodecillion fingers',getStrThousandFingersGain(20)+'<q>It\'s okay. You can stop clicking now.</q>',10000000000000000000000000000000,[12,36]);Game.MakeTiered(Game.last,16,0);
