...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		order=90000;
		Game.NewUpgradeCookie({name:'Aged cookies',desc:'Literally aged like milk, I wouldn\'t eat these if I were you.',icon:[28,36],requirement:Grandma.amount>=250,power:5,price:2*Math.pow(10,31)});
