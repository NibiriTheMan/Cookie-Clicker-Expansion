...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		new Game.Object('Sky citadel','sky citadel|sky citadels|coagulated|[X] sky charted|[X] skies charted','Harvests the air to be extracted and turned into cookies.',6,6,{base:'citadel',xV:16,yV:16,w:64,rows:1,x:0,y:0},10000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		Game.Tiers={
			...
			16:{name:'Kalathunzite',unlock:700,achievUnlock:700,iconRow:36,color:'#ffddbb',price:		50000000000000000000000000000000000000000000},
		...
		order=100;new Game.Upgrade('Duodecillion fingers',getStrThousandFingersGain(20)+'<q>Congratulations.<br>You\'ve mastered the core mechanic of the game.</q>',10000000000000000000000000000000,[12,36]);Game.MakeTiered(Game.last,16,0);
